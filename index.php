  ...
  <tbody>
    <tr>
      ...
      <td class="hlavicka">
        ...
        Hladat <input name="hladat" type="text" id="staznost" size="20" /><input name="search" type="submit" value="Hladať" />
        </form>
      </td>
    <tr/>
    <tr>
        ...
        <div class="staznost">
          <?php
            ...
            echo '<form  method="post">
                    ...
                    <p><input type="submit" value="Odoslať sťažnosť" name="send"></p>
                  </form></div>';
    ...
    <tr>
      <td class="popis">
        Prečíťajte si najnovšie sťažnosti
      </td>
    </tr>
        <?php
          include('db.php');
